...
<html>
    ...
    <body>
        <div id="div_navigation_form">
			...
			<div class="div_links_navigation"><table><tr><td class="td_bilder"><img src="pictures/impressum.png" alt="Ausbilungszweig-Symbol" height="24" width="24"></td><td class="td_text_bilder">Impressum</td></tr></table></div>
			<div style="border-bottom:1px solid #ededed"></div>
